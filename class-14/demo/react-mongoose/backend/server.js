...
server.put('/updateCat/:catID',updateCatHandler);
...
function updateCatHandler (req,res) {
    ...
    console.log(req.body)
    kittenModel.findOne({_id:catID},(error,catInfo) =>{
        console.log(catInfo)
        // catInfo[0].ownerName = ownerName;
        // catInfo[0].catName= catName;
        // catInfo[0].catBreed= catBreed;
